...
public class TransferTransaction extends Transaction {
    ...
    public TransferTransaction(Card fromCard, Card toCard, String typeOfOperation, float sum, char currencySymbol) {
        super(fromCard, toCard, typeOfOperation, sum, currencySymbol);
    }

    public TransferTransaction(Card fromCard, Account toAccount, String typeOfOperation, float sum, char currencySymbol) {
        super(fromCard, toAccount, typeOfOperation, sum, currencySymbol);
    }

    public TransferTransaction(Account fromAccount, Account toAccount, String typeOfOperation, float sum, char currencySymbol) {
        super(fromAccount, toAccount, typeOfOperation, sum, currencySymbol);
    }

    public TransferTransaction(Account fromAccount, Card toCard, String typeOfOperation, float sum, char currencySymbol) {
